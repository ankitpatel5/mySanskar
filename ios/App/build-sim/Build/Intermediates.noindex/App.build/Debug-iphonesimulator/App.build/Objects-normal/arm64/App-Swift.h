...
SWIFT_CLASS_NAMED("GoogleSignInPlugin")
@interface GoogleSignInPlugin : CAPPlugin <CAPBridgedPlugin>
...
- (void)signIn:(CAPPluginCall * _Nonnull)call;
- (void)signOut:(CAPPluginCall * _Nonnull)call;
...
@interface SignInWithApple : CAPPlugin <ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding, CAPBridgedPlugin>
@property (nonatomic, readonly, copy) NSString * _Nonnull identifier;
@property (nonatomic, readonly, copy) NSString * _Nonnull jsName;
@property (nonatomic, readonly, copy) NSArray<CAPPluginMethod *> * _Nonnull pluginMethods;
- (void)authorize:(CAPPluginCall * _Nonnull)call;
