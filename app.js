...
(() => {
  ...
  // "Repeat each line" (default ON). OFF = skip the line-by-line section and
  // play each video from where the full-shlok chant starts (sd-meta.js,
  // generated by scripts/build-sd-meta.py). Shloks without metadata fall
  // back to the whole video.
  let _sdRepeatLines = localStorage.getItem('drift.sdRepeatLines') !== '0';
